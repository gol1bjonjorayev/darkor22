...
public class FileService extends AbstractService<FileMapper, FileRepository> {
    ...
    private static String extensions = "{jpg};{png};{PNG};{JPG};{jpeg};{JPEG};{mp4};{MP4};{webm);{WEBM};{flv};{vob};{avi};{gif};{mov}";
...
//    private String urlPath;
    ...
    public FileDTO save(MultipartFile file, ContentType type) throws IOException {
        ...
        try {
            ...
            String url = "http://172.105.11.236:80" + BaseUtils.PATH.concat("/download/".concat(generatedName));
