...
public interface CourseService extends GenericCUDService<CourseCreateDTO, CourseUpdateDTO, CourseLocalizationDTO, UUID>,
        GenericGLService<CourseLocalizationDTO, CourseCriteria, UUID> {
}
