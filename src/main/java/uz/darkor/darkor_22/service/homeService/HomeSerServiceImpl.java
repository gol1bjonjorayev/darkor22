...
//        homeService.setGalleryUz(fileRepository.findById(DTO.getGalleryUz().getId()).orElseThrow(() -> new NotFoundException("Not null")));
        ...
        homeService.setYouTubeVideo(DTO.getYouTubeVideo());
