...
public interface EmployeeDetailController
        extends GenericCUDController<EmployeeDetailCreateDTO, EmployeeDetailUpdateDTO, EmployeeDetailLocalizedDTO, UUID>,
        GenericGLController<EmployeeDetailLocalizedDTO, BaseCriteria, UUID> {
}
